...
## Reproducable Activity Project

# Loading the Data

```{r echo = TRUE}
setwd("~/R_PROGRAME/repdata_data_activity")
library(ggplot2)
...
```
## Finding the mean and median of total step taken
```{r echo = TRUE}
...
```
## 5-Minutes interval which contain the maximum numbers of steps on daily bases
...
# Mean and Median of total step taken per day
